...
export default function RadialOrbitalTimeline({
  ...
  return (
    <div
      className="w-full h-[620px] md:h-[720px] flex flex-col items-center justify-center overflow-hidden"
      ref={containerRef}
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-amber-500/90 via-rose-500/80 to-purple-500/80 animate-pulse flex items-center justify-center z-10">
                      ...
                      <div className="mt-4 pt-3 border-t border-white/10">
                        <div className="flex justify-between items-center text-xs mb-1">
                          <span className="flex items-center">
                            <Zap size={10} className="mr-1" /> Rarity
                          </span>
